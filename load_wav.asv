...
% Room A
cd room_a\feat2\ 
[y_a, ~] = audioread("imp_resp_a.wav");
[y_b, ~] = audioread("imp_resp_b.wav");
cd ..\..\data\feat2
save("imp_resp_a_a.mat", "y_a");
save("imp_resp_b_a.mat", "y_b");
cd ..\..
...
[y_b, ~] = audioread("imp_resp_b.wav");
cd ..\..\data\feat2
save("imp_resp_a_b.mat", "y_a");
save("imp_resp_b_b.mat", "y_b");
cd ..\..
